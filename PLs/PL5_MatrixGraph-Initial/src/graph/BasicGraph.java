...
public interface BasicGraph<V, E> {
     ...
     *
     * @param va the two vertices
     * @param vb the two vertices
     ...
     *
     * @param va the two vertices and the new edge contents
     * @param vb the two vertices and the new edge contents
